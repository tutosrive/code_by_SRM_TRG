...
public class java_Scanner2 {
    public static void main(String[] args) {
        ...
        /*
         * Mencionaba en java_Scanner1.java, que habían errores en dicho documento, pues
         * el error es que se usa una sola instancia
         * para todos los tipos de datos. Se darán cuenta que si usan un Scanner para
         * leer Strings, y luego quieren pedir
         * al usuario la edad con ese mismo Scanner, en muchos casos no los dejará
         * ingresar la edad (int), porque
         * el Scanner cuando leyó un String antes, quedó configurado para leer String o
         * char, por eso hay alternativas para
         * evitar esos errores.
         */

        // Primer alternativa: Hacer varias instancias de Scanner para diferentes tipos
        // de datos
        ...
        // Char
        System.out.println(
                "Ingrese su género (No me salgas con mkdas de LGTBIQ+) binario (f -> Femenino - m -> Masculino): ");
        ...
        // Alternativa 2: Un solo Scanner para todo tipo de dato, pero hacer una especie
        // de cambio (casteo) al nuevo
        ...
        // Los Scanner siempre se cierran cuando estamos seguros que no los volveremos a
        // usar
